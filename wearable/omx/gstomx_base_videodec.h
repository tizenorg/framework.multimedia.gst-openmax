...
typedef struct EnableTimestampReorderParams EnableTimestampReorderParams;
typedef struct EnableGemBuffersParams EnableGemBuffersParams;

#define HLS_MAX_WIDTH 1280 // Just an assumption that resolution in HLS will not cross HD
#define HLS_MAX_HEIGHT 720
...
struct EnableTimestampReorderParams {
  OMX_U32 nSize;
